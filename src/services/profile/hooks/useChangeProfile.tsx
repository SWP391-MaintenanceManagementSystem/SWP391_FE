import { ChangeProfileSchema, type ChangeProfileFormData } from "@/pages/profile/components/profile/libs/schema";
...
export default function useChangeProfile(user: AccountWithProfile | undefined) {
    ...
    const form = useForm<ChangeProfileFormData>({
        ...
        defaultValues: {
            ...
            phone: user?.phone || "",
            address: user?.role === AccountRole.CUSTOMER ? (user?.profile as Customer)?.address || "" : undefined,
        },
    });
