  ...
  return (
    <div className="w-full h-[calc(100vh-32px)] flex flex-col">
      ...
      {openCreateVehicleModal && (
        <AddVehicleFormModal
          open={openCreateVehicleModal}
          onClose={() => setOpenCreateVehicleModal(false)}
          form={form}
          onSubmit={onSubmit}
        />
      )}
      <MainContentLayout className="flex flex-col font-inter">
        <div className="flex w-full justify-between items-center mb-6">
          ...
          <div className="flex gap-4 w-full max-w-md">
            ...
            />
            <Button
              className="bg-purple-primary text-white dark:text-amber-primary"
              onClick={() => setOpenCreateVehicleModal(true)}
            >
              <Plus />
              Add Vehicle
            </Button>
        ...
        <div
          className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 self-center
  gap-8 h-screen overflow-auto"
        >
          {filteredVehicles &&
