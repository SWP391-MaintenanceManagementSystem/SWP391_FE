...
export function AddScheduleDialog({
  ...
  return (
    ...
    >
      <DialogContent
        className="w-[90vw] sm:max-w-[500px] lg:max-w-[640px] font-inter"
      ...
      >
        ...
        <Form {...form}>
          <form
            ...
            className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[70vh] overflow-y-auto px-1"
          >
            {form.formState.errors.root?.serverError?.message && (
              <div className="sm:col-span-2 mt-3 rounded-md bg-red-50 p-3 border border-red-200">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="outline"
                          className={clsx(
                            "w-full justify-between items-center gap-2 max-w-full",
                            form.formState.errors.centerId &&
                              "border-destructive focus:ring-destructive",
                          )}
                        >
                          <span className="truncate text-left block flex-1 max-w-[200px] sm:max-w-[260px]">
              ...
              render={({ field }) => {
                ...
                return (
                  <FormItem className="sm:col-span-2">
                    ...
                    <div className="flex flex-wrap justify-between gap-1 md:max-w-[400px]">
                      {[
                        { label: "Su", value: 0 },
                        { label: "Mo", value: 1 },
                        { label: "Tu", value: 2 },
            ...
            {/* Footer */}
            <DialogFooter className="flex flex-col sm:flex-row sm:justify-end gap-2 sm:gap-3 sm:col-span-2 mt-2">
