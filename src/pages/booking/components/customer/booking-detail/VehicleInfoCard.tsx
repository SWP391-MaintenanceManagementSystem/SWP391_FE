...
export default function VehicleInfoCard({
  ...
  return (
    <Card className="w-full p-0 hover:shadow-lg dark:hover:shadow-gray-700 transition-shadow duration-300 border border-gray-200 dark:border-[#262626] rounded-lg overflow-hidden">
