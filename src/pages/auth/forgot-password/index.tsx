...
export default function ForgotPasswordPage() {
    const { form, handleRequestReset, pageType, PageType, handleVerifyReset, handleReset, handleResendCode } = useResetPassword();
    const { auth } = useAuth()
            ...
            <div className="min-h-fit flex items-center justify-center lg:mx-24 mx-4 overflow-hidden mt-40 shadow-lg lg:shadow-none">
                <div className="w-screen space-y-8 p-6 flex flex-col flex-1 justify-center">
                    <div className="text-center lg:text-left ">
                        <NavLink to="/login" className="flex items-center !text-sm !text-gray-500 mb-10">
                        ...
                        {pageType === PageType.REQUEST && (
                            <>
                                <div className="mb-12">
                                    ...
                                    <p>
                                        Enter your <strong className="text-purple-primary text-sm">email</strong> below and we’ll send you a reset code.
                                    </p>
                                </div>
                                <ForgotPasswordForm form={form.forgot} onSubmit={handleRequestReset} />
                            </>
                        )}
                        ...
                        {pageType === PageType.VERIFY && (
                            <>
                                <div className="mb-12">
                                    ...
                                    <p>
                                        Enter the <strong className="text-purple-primary text-sm">reset code</strong> below to continue.
                                    </p>
                                </div>
                                <ResetCodeForm form={form.code} onSubmit={handleVerifyReset} handleResendCode={handleResendCode} />
                            </>
                        )}
                        ...
                        {pageType === PageType.RESET && (
                            <>
                                <div className="mb-12">
                                    ...
                                    <p>
                                        Please enter a <strong className="text-purple-primary text-sm">new password</strong> for your account.
                                    </p>
                                </div>
                        ...
                        {pageType === PageType.SUCCESS && (
                            <>
                                <h3 className="text-3xl font-semibold">Password reset successful!</h3>
