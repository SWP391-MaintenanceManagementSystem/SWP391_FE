...
export default function ProfileForm({ user, form, onSubmit }: ProfileFormProps) {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
                <div className="grid gap-6 w-full">
                        ...
                        <FormField
                            ...
                            render={() => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input value={user?.email || ""} disabled className="bg-gray-200 cursor-not-allowed" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                    ...
                    <div className="mt-4 flex justify-start lg:justify-end">
                        <Button type="submit" className="!bg-purple-primary !text-white cursor-pointer" disabled={form.formState.isSubmitting}>
                            Save Changes
                        </Button>
                    </div>
                </div>
