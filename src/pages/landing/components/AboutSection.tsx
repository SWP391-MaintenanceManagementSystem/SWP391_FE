...
export default function AboutSection() {
  return (
    <section className="w-full bg-black py-16 sm:py-24 md:py-32">
      <div className="w-full px-[44px]">
        {/* Heading */}
        <div className="text-left">
          <div className="flex items-center gap-2">
            <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-purple-light" />
            <span className="text-base sm:text-lg md:text-2xl text-purple-light tracking-widest">
              WHO WE ARE
            </span>
          </div>

          <h2 className="mt-3 text-xl sm:text-2xl md:text-3xl font-extrabold text-slate-50 leading-snug">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10 sm:mt-14 items-stretch">
          ...
          <div className="flex flex-col justify-between h-full">
            <p className="text-sm sm:text-base md:text-lg text-sub-text leading-relaxed">
