    ...
    <section className="w-full py-16 sm:py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center my-16 md:my-24">
        <div className="flex flex-col items-center text-center leading-none">
          <span className="text-5xl ms:text-9xl lg:text-[200px] font-bold">
            SMOOTH
          </span>
          <span className="text-5xl ms:text-9xl lg:text-[200px] font-bold text-purple-landing">
            SERVICE
          </span>
        </div>
        <img
          ...
          className="absolute top-1/2 -translate-y-1/2 scale-50 lg:scale-80"
        />
      </div>
